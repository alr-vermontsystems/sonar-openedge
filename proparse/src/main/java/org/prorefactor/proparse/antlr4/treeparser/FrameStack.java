...
public class FrameStack {
   ...
   */
  public void frameRefNode(JPNode idNode, ITreeParserSymbolScope symbolScope) {
    if (idNode.getSymbol() == null)
  ...
  public void nodeOfBlock(JPNode blockNode, IBlock currentBlock) {
   ...
   */
  public void nodeOfInitializingStatement(JPNode stateNode, IBlock currentBlock) {
   ...
   */
  public void simpleFrameInitStatement(JPNode headNode, JPNode frameIDNode, IBlock currentBlock) {
